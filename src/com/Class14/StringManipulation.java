...
public class StringManipulation {
	...
	public static void main(String[] args) {
		...
		//what we are looking for to replace 
		...
		//2 replaceAll() -will replace all that matched that matches specified pattern [regex]; 
		...
		// String replacedNoCharacter=replacedNoNUmbers.replacedAll("[A-Za-z]","");
